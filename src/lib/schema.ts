...
const identityNode: MultiType<ProfessionalService, ['Organization', 'ProfessionalService']> = {
  ...
  'description': 'PXLC accompagne les familles dans l’éducation numérique des enfants. Médiation numérique en Guadeloupe, portée par Andy Zébus, auprès des lieux d’accueil des familles.',
  'email': IDENTITY.email,
  'founder': { '@id': ID.andy },
  'foundingDate': '2015',
...
const andyNode: Node<Person> = {
  ...
  'description': 'Médiateur numérique basé à Les Abymes (Guadeloupe). Aide les lieux d’accueil des familles — SESSAD, IME, associations, collectivités — à accompagner les familles autour des écrans : conflits autour du temps d’écran, bonnes pratiques numériques.',
  'hasCredential': [
...
const serviceNode: Node<Service> = {
  ...
  'description': 'Médiation numérique pour les lieux d’accueil des familles en Guadeloupe. Résolution des conflits autour du temps d’écran, ateliers de bonnes pratiques, vulgarisation numérique.',
